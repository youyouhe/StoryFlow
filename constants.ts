...
export const TRANSLATIONS = {
  en: {
    ...
    expressTitle: "Express gacha workbench",
    expressDuration: "Clip length",
    expressNoShots: "No generatable shots yet — generate storyboard prompts first (Alt+S), then come back.",
    expressNeedComfy: "I2V needs ComfyUI: set the server URL and import the I2V workflow in Settings → AI.",
    expressGenFrame: "First frame",
    expressGenVideo: "Generate",
    expressReroll: "Reroll",
    expressPreview: "Preview",
    expressLock: "Lock this shot (kept for export, reroll blocked)",
    expressUnlock: "Unlock",
    expressLockedHint: "Shot is locked — unlock to reroll",
    expressFootnote: "First frames go to the asset library; clips live on your ComfyUI server (session-scoped). Locked shots are pinned for export.",
    expressStIdle: "Idle",
    expressStImaging: "Framing…",
    expressStFrame: "Frame ready",
    expressStGenerating: "Generating…",
    expressStReady: "Clip ready",
    expressStFailed: "Failed",
    ...
    productionModeLabel: "Pipeline mode",
    productionModeExpress: "Express",
    productionModeExpressDesc: "Gacha pipeline: imagePrompt → first frame → I2V → per-shot keep/reroll → concat export. No graybox/TTS/BGM.",
    productionModePro: "Pro (Director)",
    productionModeProDesc: "Full pipeline: ref registry + SHOT_LIST + consistency preflight + TTS timed durations + BGM/SFX mixing.",
    proAudioTitle: "Pro audio tracks",
    proVoiceCast: "Voice cast (GLM-TTS)",
    proNeedBigmodel: "BIGMODEL_TOKEN not set — TTS unavailable in this build.",
    proSynthTts: "Synthesize dialogue",
    proLowerBound: "TTS lower bound",
    proFitOut: "fitted output",
    proBgmRequest: "Request BGM",
    proBgmRedo: "Redo BGM",
    proSfxSuggest: "Suggest SFX",
    proAudioTooLongHint: "Dialogue exceeds the planning window — split the segment or raise the speed.",
    proAudioFootnote: "Audio bytes are session-scoped; durations and URLs persist with the script. Mixing happens at export.",
    expressExport: "Export cut",
    modeUpgradeTitle: "Switch to Pro mode?",
    modeUpgradeBody: "Once upgraded to Pro mode there is no way back to Express — the ref registry, SHOT_LIST, TTS and BGM features become active.",
    modeUpgradeOk: "Upgrade",
    modeSwitchProReason: "Pro features (proAudio / voiceCast / SHOT_LIST) depend on Pro mode — switching to Express is disabled.",
    modeSwitchDataReason: "This project carries Pro-mode data (proAudio / voiceCast) — downgrade to Express is locked.",
    modeSwitchProDataChip: "Has Pro data",
    proExportCut: "Export cut",
    proExportTitle: "Mux each segment's TTS/BGM/SFX with its finished video, then concat",
    cloudCookieLoginTitle: "4A sign-in session detected",
    cloudCookieLoginOk: "Sign in & enable cloud sync",
    cloudAskLater: "Not now",
    cloudPullTitle: "New cloud scripts found",
    cloudPullNow: "Pull & remember",
    cloudPullSkip: "Skip once",
  ...
  zh: {
    ...
    // ---- privacy remediation (2026-09): consent + disclosure ----
    expressTitle: "Express 抽卡工作台",
    expressDuration: "片段时长",
    expressNoShots: "还没有可生成的镜头——先用 Alt+S 生成分镜提示词,再回来抽卡。",
    expressNeedComfy: "I2V 需要 ComfyUI:请在 设置 → AI 中填写服务器地址并导入 I2V 工作流。",
    expressGenFrame: "首帧",
    expressGenVideo: "生成",
    expressReroll: "重roll",
    expressPreview: "预览",
    expressLock: "锁定该镜头(导出采用,重roll已禁用)",
    expressUnlock: "解锁",
    expressLockedHint: "镜头已锁定——解锁后才能重roll",
    expressFootnote: "首帧会存入资产库;视频保存在你的 ComfyUI 服务器(会话级)。锁定的镜头导出时固定采用。",
    expressStIdle: "未开始",
    expressStImaging: "出图中…",
    expressStFrame: "首帧就绪",
    expressStGenerating: "生成中…",
    expressStReady: "可预览",
    expressStFailed: "失败",
    ...
    productionModeLabel: "流水线模式",
    productionModeExpress: "简洁 Express",
    productionModeExpressDesc: "抽卡流水线：imagePrompt → 首帧 → I2V → 逐镜头保留/重roll → 拼接导出。不需要灰盒/TTS/BGM。",
    productionModePro: "专业 Pro（导演）",
    productionModeProDesc: "导演全流程：参考系注册表 + SHOT_LIST + 一致性校验 + TTS 定时长 + BGM/SFX 混音。",
    proAudioTitle: "Pro 音轨工作台",
    proVoiceCast: "角色音色(GLM-TTS)",
    proNeedBigmodel: "未设置 BIGMODEL_TOKEN——本构建无法使用 TTS。",
    proSynthTts: "合成对白",
    proLowerBound: "TTS 下限",
    proFitOut: "拟合输出",
    proBgmRequest: "生成 BGM",
    proBgmRedo: "重做 BGM",
    proSfxSuggest: "建议音效",
    proAudioTooLongHint: "对白超过规划窗口——请拆段或提高语速。",
    proAudioFootnote: "音频字节为会话级;时长与 URL 随剧本持久化。混音在导出时执行。",
    expressExport: "导出成片",
    modeUpgradeTitle: "升级为专业模式？",
    modeUpgradeBody: "升级为专业模式后不可退回简洁模式，将启用参考系/SHOT_LIST/TTS/BGM 等专业特性。",
    modeUpgradeOk: "确认升级",
    modeSwitchProReason: "专业模式特性（proAudio / voiceCast / SHOT_LIST）依赖专业模式，不能切换到简洁模式。",
    modeSwitchDataReason: "项目已包含专业模式数据（proAudio / voiceCast），禁止降级为简洁模式。",
    modeSwitchProDataChip: "含专业数据",
    proExportCut: "导出成片",
    proExportTitle: "把每段的 TTS/BGM/SFX 与完成的视频混音后顺序拼接",
    cloudCookieLoginTitle: "检测到 4A 登录会话",
    cloudCookieLoginOk: "登录并开启云同步",
    cloudAskLater: "暂不",
    cloudPullTitle: "发现云端新剧本",
    cloudPullNow: "拉取并记住",
    cloudPullSkip: "本次不拉",
